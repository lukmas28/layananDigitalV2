          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Pengajuan Surat</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="suratmasuk" class="menu-link">
                    <div data-i18n="Without menu">Surat Masuk</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="suratselesai" class="menu-link">
                    <div data-i18n="Without navbar">Surat Selesai</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              <a href="masteruser" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Basic">User</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="masterrw" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Akun RT RW</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="masterkk" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Kartu Keluarga</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="mastersurat" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Surat Keterangan</div>
              </a>
            </li>
            <li class="menu-item">
